library("GSVA")
#'~/FileZilla Downloads/Data for Web Portal Codes offline 070518/DataOptra/LINCS_RGES/lincs_signatures_cmpd_landmark_symbol.RData'
...
pdf(paste0(outputFolder, "/top_enriched_", target_type, ".pdf"))
