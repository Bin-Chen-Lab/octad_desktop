...
lincs_sig_info <- fread(paste0(pipelineDataFolder,"/LINCS_RGES/lincs_sig_info.csv"), stringsAsFactors = TRUE)

# lincs_sig_info1 <- fread(paste0(pipelineDataFolder,"/LINCS_RGES/lincs_sig_info.csv")) # from data.table, faster read
